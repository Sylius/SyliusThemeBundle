...
final class LegacyApplicationTemplateLocatorSpec extends ObjectBehavior
{
    ...
    function it_locates_application_resource(Filesystem $filesystem, ThemeInterface $theme): void
    {
        ...
        $filesystem->exists('/theme/path/views/resource')->willReturn(true);

        $this->locate('resource', $theme)->shouldReturn('/theme/path/views/resource');
    }
    ...
    function it_throws_an_exception_if_resource_can_not_be_located(Filesystem $filesystem, ThemeInterface $theme): void
    {
        ...
        $filesystem->exists('/theme/path/views/resource')->willReturn(false);
