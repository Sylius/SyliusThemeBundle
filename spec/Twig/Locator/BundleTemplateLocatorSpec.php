...
final class BundleTemplateLocatorSpec extends ObjectBehavior
{
    ...
    function it_locates_bundle_resource_using_path_derived_from_bundle_notation_and_symfony4_kernel_behaviour(
        ...
        $this->locate('@JustBundle/Resources/views/Directory/index.html.twig', $theme)->shouldReturn('/theme/path/templates/bundles/JustBundle/Directory/index.html.twig');
    }
