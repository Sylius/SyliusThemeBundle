...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set(ApplicationTemplateLocator::class)
        ->args([
            service('filesystem'),
        ])
    ...
    $services
        ->set(NamespacedTemplateLocator::class)
        ->args([
            service('filesystem'),
        ])
        ->tag('sylius_theme.twig.template_locator')
    ...
    $services
        ->set(TemplateLocatorInterface::class, CompositeTemplateLocator::class)
        ->args([
            tagged_iterator('sylius_theme.twig.template_locator'),
        ])
    ;

    $services
        ->set(HierarchicalTemplateLocator::class)
    ...
    $services
        ->set(ThemedTemplateLoader::class)
