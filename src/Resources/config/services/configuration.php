...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->alias('sylius.theme.configuration', ThemeConfiguration::class)
    ...
    ;
    $services
        ->alias('sylius.theme.configuration.processor', ConfigurationProcessorInterface::class)
        ->deprecate('sylius/theme-bundle', '2.0', '"%alias_id%" service is deprecated since Sylius/ThemeBundle 2.0 and will be removed in 3.0.')
    ;

    $services
        ->set(ConfigurationProviderInterface::class, CompositeConfigurationProvider::class)
        ->args([
            [], // an array of configuration providers
        ])
    ;
    $services
        ->alias('sylius.theme.configuration.provider', ConfigurationProviderInterface::class)
        ->deprecate('sylius/theme-bundle', '2.0', '"%alias_id%" service is deprecated since Sylius/ThemeBundle 2.0 and will be removed in 3.0.')
    ;
};
